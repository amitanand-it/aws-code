...
export const handler = async(event) => {
	...
	//let path = 'https://tiimg.tistatic.com/new_website1/micro_cate_images/2/b/72/31372-w30.jpg';
	let imgurl = event['pathParameters']['imgurl'];
	let path = `https://tiimg.tistatic.com/${imgurl}`;
